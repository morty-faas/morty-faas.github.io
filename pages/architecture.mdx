...
This page describes the high-level architecture of Morty. The goal of this document is to give anyone interested in contributing to Morty a high-level overview of how it works. This tries to stay high level to guide to the right area of Morty, but stops short of explaining in detail how something might work since it's easy for that to get out of sync with the codebase.
