...
Database will be reinitialized every time the function is instanciated. This is because the function is stateless and will be destroyed after some time of inactivity.
