...
export default {
  ...
  head: () => {
    ...
    const description = frontMatter.description ?? 'Morty is an open source serverless platform allowing users to deploy function as a service, without the need of managing servers.'
    const image = frontMatter.image ?? `https://raw.githubusercontent.com/morty-faas/.github/main/assets/morty.jpg`
